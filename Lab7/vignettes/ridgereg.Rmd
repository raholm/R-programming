...
The last model is the ridge regression and similar to the previous model, we use cross validation and grid search to optimize the lambda parameter. The training error is as expected lower than the test error and the optimal lambda was around 0.025.
