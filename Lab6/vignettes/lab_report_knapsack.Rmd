...
microbenchmark(
  Brute=knapsack_brute_force(x=my_df[1:16,], W=3500),
  Brute_Cpp=knapsack_brute_force(x=my_df[1:16,], W=3500, fast=TRUE),
  Dynamic=knapsack_dynamic(x=my_df[1:500,], W=3500),
  Dynamic_Cpp=knapsack_dynamic(x=my_df[1:500,], W=3500, fast=TRUE),
  Greedy=knapsack_greedy(x=my_big_df[1:1000000,], W=3500),
  Greedy_Cpp=knapsack_greedy(x=my_big_df[1:1000000,], W=3500, fast=TRUE),
  times=1
  )
```
